                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('store') }}" enctype="multipart/form-data">
                            ...
                            <div class="form-group row my-4">
                                ...
                                <div class="col-md-6">
                                    <input id="passport" accept="image/*" type="file" class="form-control @error('passport') is-invalid @enderror" name="passport" value="{{ old('passport') }}" required>
                            ...
                            <div class="form-group row my-4">
                                ...
                                <div class="col-md-6">
                                    <input id="carte" accept="image/*" type="file" class="form-control @error('carte') is-invalid @enderror" name="carte" value="{{ old('carte') }}" required>
